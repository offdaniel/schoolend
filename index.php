...
<head>
  ...
  <script src="client/getdata.js"></script>
</head>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-black fixed-top py-3">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
            <ul class="navbar-nav fs-5">
                ...
                <li class="nav-item" style="margin-right: 10px;">
                    <a class="nav-link" href="index.php?prog=client/elektromos.php">Elektromos gépek</a>
                </li>
                <li class="nav-item" style="margin-right: 10px;">
                    <a class="nav-link" href="index.php?prog=client/akkumlatoros.php">Akkumlátoros gépek</a>
                </li>
            </ul>
            <ul class="navbar-nav navbar-nav-center">
                <li class="nav-item">
                    <button class="nav-link" type="button" onclick="info(this)" data-bs-toggle="modal" 
                    data-bs-target="#exampleModal"><img src="client/kepek/info.png" style="max-width: 30px"></button>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="index.php?prog=client/search.php">
                      <img src="client/kepek/search.png" style="max-width: 30px"></a>
                </li>
            </ul>
        </div>
      </nav>
  ...
  function info() {
    ...
    var modalBody = document.querySelector('.modal-body');
      ...
      `<div style="font-size:19px">
        ...
        target="_blank"><img src="client/kepek/maps.jpg" style="max-width: 80px;"></a></div>
       </div>`;
  }
